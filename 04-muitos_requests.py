...
def obter_requests(url, params=None): 
    """faz uma requsição GET e retorna uma resposta em JSON"""
    try:
...
def busca_id_estado():
    """Obtem um dicionário de estados no formato {id_estado: nome_estado}"""
...
def main(name):
    ...
    print(f"=== Frequencia do nome {name} nos estados (por 100.000 habitantes)===")
